...
//    int amount_el, el, i;
//
//    for (i = 0; i < sz; i++) // Вывод
//        cout << arr[i] << ' ';
//
//    cout << "\nВведите количество элементов, которое хотите удалить\n";
//    cin >> amount_el;
//    amount_el = abs(amount_el);
//
//    cout << "Введите первый элемент, начиная с которого хотите удалить " << amount_el << " элементов (1-10)\n";
//    cin >> el;
//    el = abs(el);
//    if (el > 10)
//    {
//        cout << "Неверный элемент, такого элемента в массиве нет\n\n";
//    }
//    else
//    {
//        if (amount_el > 10 || amount_el == 0)
//        {
//            cout << "Введите количество элементов, которое хотите удалить, от 1 до 10\n\n";
//        }
//        else
//        {
//            el -= 1;
...
//{
//	const int SIZE = 15;
//	int arr[]{1,15,-3,2,7,3,-10,-6,0,0,0,0,0,0,0};
//	
//
//	int i_ins;
//	int vol;
//	while (true) {
//		for (int i = 0; i < SIZE; i++) cout << setw(5) << arr[i];
//
//		cout << endl << "Put the index of element " << endl;
//		cin >> i_ins;
//
//		int arr2[SIZE +1];
//		for (int i = 0; i < SIZE; i++) arr2[i] = arr[i];
//
//		for (int i = SIZE; i > i_ins; i--) arr2[i] = arr[i - 1];
//
//		
//
//		//cout << "How much ? " << endl;
...
//		//	
//		//}*/
//		cout << "What element you wanna to put" << endl;
//		cin >> vol;
//		arr2[i_ins] = vol;
//
//		
...
//
//		for (int i = 0; i < SIZE + 1 ; i++) cout << setw(5) << arr2[i];
//
//	}
//}
